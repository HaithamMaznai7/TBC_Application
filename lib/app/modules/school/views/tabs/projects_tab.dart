...
class ProjectsTab extends GetView<SchoolDetailsController> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        actions: [
          IconButton(
            icon: Icon(Iconsax.add, size: 30, color: FColors.primary),
            onPressed: () => Get.toNamed(Routes.ADD_CONTRACTOR),
          ),
        ],
      ),
      body: Padding(
