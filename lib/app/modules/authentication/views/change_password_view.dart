                    ...
                    Expanded(
                      child: Column(
                        ...
                        children: [
                          ...
                          Text(
                            LoginPage.changePasswordTitle.tr,
                            style: Theme.of(context).textTheme.headlineMedium,
                            textAlign: TextAlign.center,
                          ),
                          Text(
                            LoginPage.changePasswordSubTitle.tr,
                          ...
                          children: [
                            Obx(() => TextFormField(
                              ...
                              decoration: InputDecoration(
                                ...
                                labelText: LoginPage.oldPassword.tr,
                                suffixIcon: IconButton(
                                  ...
                                  onPressed: controller.oldPasswordVisibleChange,
                                ),
                              ),
                            ...
                            Obx((){
                              ...
                              return SizedBox(
                                width: double.infinity,
                                child: ElevatedButton(onPressed: controller.updatePassword , child: Text(LoginPage.changePassword.tr,style: Theme.of(context).textTheme.headlineSmall?.apply(color: FColors.white),))
                              );
                            }),
                          ],
                        ),
