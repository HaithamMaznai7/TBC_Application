...
class AddSupervisorView extends GetView<SupervisorsController> {
  @override
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text(
          '${controller.supervisor == null ? "Add" : "Edit"} Supervisors',
          style: TextStyle(
            ...
            child: Obx(
              () => ElevatedButton(
                ...
                child: Text(
                  ...
                  ? '${controller.supervisor == null ? "Create" : "Save"} Supervisor' 
                  : 'Loading...',
                  style: TextStyle(
                    fontSize: 16,
                    fontFamily: 'poppins',
